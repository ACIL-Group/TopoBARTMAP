function [y, TBM] = run_TopoBARTMAP_Unsupervised(x, data)

%{
    :param x: array of settings.
    :param data: array of shape #genesX#observations.
    :param classes: array of true observation labels for the presented data.
%}
...
%% Compute ARI
    perf = valid_internal_deviation(data, TBM.TAa.Label(1)', 1)

%% Return fitness value [DB,CH,Dunn,KL,Han,st]
    y = perf(2);
